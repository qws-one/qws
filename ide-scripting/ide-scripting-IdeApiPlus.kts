...
open class IdeApi(private val ideApiObj: Any) {
    ...
    class Application(val ideAppObj: Any) {
        ...
        private val methodInvokeLaterOnWriteThread by lazy { ideAppObj.javaClass.getDeclaredMethod("invokeLaterOnWriteThread", Runnable::class.java) }
        ...
        fun invokeLaterOnWriteThread(runnable: Runnable) {
            methodInvokeLaterOnWriteThread.invoke(ideAppObj, runnable)
        }
    }
