...
":libs:SimpleScript".let { include(it); project(it).buildFileName = ".build.gradle.kts" }
...
":tools:RunSimpleScript".let { include(it); project(it).buildFileName = ".build.gradle.kts" }
...
":tools:ide:script:two".let { include(it); project(it).buildFileName = ".build.gradle.kts" }
":tools:script:one".let { include(it); project(it).buildFileName = ".build.gradle.kts" }
":tools:toolPlainIdeListener".let { include(it); project(it).buildFileName = ".build.gradle.kts" }
":tools:toolPlainTypeAliasIdeListener".let { include(it); project(it).buildFileName = ".build.gradle.kts" }
":tools:toolSimpleScriptIdeListener".let { include(it); project(it).buildFileName = ".build.gradle.kts" }